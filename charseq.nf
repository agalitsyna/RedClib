...
def helpMessage() {
    log.info"""
    ChAR-Seq-nextflow is a pipeline to map RNA-DNA interactions in paired-end sequencing data.

    Usage:
    The typical command for launching the pipeline:
      nextflow run charseq.nf -profile test,conda,debug -params-file params-charseq.yml
